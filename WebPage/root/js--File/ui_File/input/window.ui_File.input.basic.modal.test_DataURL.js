//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/input/window.ui_File.input.basic.modal.test_DataURL.js";
 ...
 */
window.ui_File.input.basic.modal.test_DataURL = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.input.basic.modal.test_DataURL():{Array}----------" );
	...
	var p = {
		...
		, key : "smt_ui$File-Basic-Test_DataURL"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.input.basic.modal.test_DataURL():{Array}----------return o;" );
	return o;
};
