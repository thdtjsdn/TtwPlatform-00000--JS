//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/input/window.ui_File.input.basic.modal.test_ArrayBuffer.js";
if( console ) console.log( "[ S ] - " + fileNm + "----------" );
//----------------------------------------------------------------------------------------------------;

/**
 * FileUploader UI 화면에 필요한 리소스를 서버에 요청 후 View와 Controller를 생성하여 반환하고 화면에 View를 표출한다.
 ...
 */
window.ui_File.input.basic.modal.test_ArrayBuffer = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.input.basic.modal.test_ArrayBuffer():{Array}----------" );

	var host = window.apis.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		//url : "./ui/smt_ui/File/Input/smt_ui-File-Input-Basic-"
		url : host + "/ui/smt_ui/File/Input/smt_ui-File-Input-Basic-"
		, nm : "Test_ArrayBuffer"
		//, css_url : "./css_ui/"
		//, css_url : host + "/css_ui/"
		//, css_front_nm : "div-smt_ui-File-Input-Basic"
		, key : "smt_ui$File-Basic-Test_ArrayBuffer"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.input.basic.modal.test_ArrayBuffer():{Array}----------return o;" );
	return o;
};
