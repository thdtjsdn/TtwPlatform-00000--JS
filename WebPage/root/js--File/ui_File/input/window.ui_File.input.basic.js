//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/input/window.ui_File.input.basic.js";
 ...
 */
window.ui_File.input.basic = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.input.basic():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.input.basic():{Array}----------return o;" );
	return o;
};
