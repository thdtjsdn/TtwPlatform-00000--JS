//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/drop/window.ui_File.drop.basic.modal.test_ArrayBuffer.js";
 ...
 */
window.ui_File.drop.basic.modal.test_ArrayBuffer = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.drop.basic.modal.test_ArrayBuffer():{Array}----------" );

	var host = window.apis.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		//url : "./ui/smt_ui/File/Drop/smt_ui-File-Drop-Basic-"
		url : host + "/ui/smt_ui/File/Drop/smt_ui-File-Drop-Basic-"
		, nm : "Test_ArrayBuffer"
		//, css_url : "./css_ui/"
		//, css_url : host + "/css_ui/"
		//, css_front_nm : "div-smt_ui-File-Drop-Basic"
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.drop.basic.modal.test_ArrayBuffer():{Array}----------return o;" );
	return o;
};
