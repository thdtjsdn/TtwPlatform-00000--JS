//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/drop/window.ui_File.drop.basic.js";
 ...
 */
window.ui_File.drop.basic = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.drop.basic():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.drop.basic():{Array}----------return o;" );
	return o;
};
