//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/drop/window.ui_File.drop.basic.modal.test_DataURL.js";
 ...
 */
window.ui_File.drop.basic.modal.test_DataURL = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.drop.basic.modal.test_DataURL():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.drop.basic.modal.test_DataURL():{Array}----------return o;" );
	return o;
};
