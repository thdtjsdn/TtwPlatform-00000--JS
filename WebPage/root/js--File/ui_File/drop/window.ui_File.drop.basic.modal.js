//----------------------------------------------------------------------------------------------------;
var fileNm = "js--File/ui_File/drop/window.ui_File.drop.basic.modal.js";
 ...
 */
window.ui_File.drop.basic.modal = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_File.drop.basic.modal():{Array}----------" );

	var host = window.apis.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		//url : "./ui/smt_ui/File/Drop/smt_ui-File-Drop-"
		url : host + "/ui/smt_ui/File/Drop/smt_ui-File-Drop-"
		, nm : "Basic"
		//, css_url : "./css_ui/"
		//, css_url : host + "/css_ui/"
		, css_front_nm : "div-smt_ui-File-Drop-"
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_File.drop.basic.modal():{Array}----------return o;" );
	return o;
};
