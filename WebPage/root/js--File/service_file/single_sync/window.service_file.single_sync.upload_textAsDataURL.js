//----------------------------------------------------------------------------------------------------;
//var fileNm = "js--File/service_file/single_sync/window.service_file.single_sync.upload_textAsDataURL.js";
...
window.service_file.single_sync.upload_textAsDataURL = function( d, cbFunction )
{
	...
	var url = window.apis.url.getServerURLByServers( window.apis.STATIC.CONFIG.URL.SCODE + "_APIServer" ) + "/file/single_sync/upload_textAsDataURL?"
