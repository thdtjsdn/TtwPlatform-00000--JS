//----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Source/service__source/compress/window.service__source.compress.html.js";
 ...
 */
window.service__source.compress.html = function( d, cbFunction )
{
	//window.TtwLog.timeStamp( "---- [ S ] - window.service__source.compress.html():void----------" );
	...
	var _url = host + "/_source/compress/html?";
	...
	//window.TtwLog.timeStamp( "---- [ E ] - window.service__source.compress.html():void----------" );
};
