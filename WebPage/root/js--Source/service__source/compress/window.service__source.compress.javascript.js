//----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Source/service__source/compress/window.service__source.compress.javascript.js";
 ...
 */
window.service__source.compress.javascript = function( d, cbFunction )
{
	//window.TtwLog.timeStamp( "---- [ S ] - window.service__source.compress.javascript():void----------" );
	...
	var _url = host + "/_source/compress/js?";
	...
	//window.TtwLog.timeStamp( "---- [ E ] - window.service__source.compress.javascript():void----------" );
};
