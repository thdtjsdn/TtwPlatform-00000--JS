//----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Source/service__source/compress/window.service__source.compress.json.js";
 ...
 */
window.service__source.compress.json = function( d, cbFunction )
{
	//window.TtwLog.timeStamp( "---- [ S ] - window.service__source.compress.json():void----------" );
	...
	var _url = host + "/_source/compress/json?";
	...
	//window.TtwLog.timeStamp( "---- [ E ] - window.service__source.compress.json():void----------" );
};
