//----------------------------------------------------------------------------------------------------;
var fileNm = "./js__b2link__SYS0015/smt_ui/apiExplorer/window.smt_ui.apiExplorer.APIExplorer_Target.js";
 ...
 * @example
 * <code>
	var els = window.smt_ui.apiExplorer.APIExplorer_Target();
	var el = els[ 0 ];
	var ec = els[ 1 ];
 * </code>
 */
window.smt_ui.apiExplorer.APIExplorer_Target = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.smt_ui.apiExplorer.APIExplorer_Target():{Array}----------" );
	...
	var p = {
		...
		, nm : "APIExplorer_Target"
		, key : "SYS0015$smt_ui$apiExplorer$APIExplorer_Target"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.smt_ui.apiExplorer.APIExplorer_Target():{Array}----------return o;" );
	return o;
};
