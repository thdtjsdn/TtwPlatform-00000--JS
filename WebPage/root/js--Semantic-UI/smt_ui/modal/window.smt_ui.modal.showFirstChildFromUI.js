//----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Semantic-UI/smt_ui/modal/window.smt_ui.modal.showFirstChildFromUI.js";
...
(function(){
	 ...
	 * </code>
	 */
	window.smt_ui.modal.showFirstChildFromUI = function( a, o )
	{
		window.Rh2Log.timeStamp( "---- [ S ] - window.smt_ui.modal.showFirstChildFromUI():void----------" );
		...
		window.Rh2Log.warn( url + "( " + window.b2link.element.getID_Or_ClassName( el ) + ") 의 자식 중 .ui .modal 클래스를 가진 첫번째 객체를 show 시킴." );

		window.Rh2Log.timeStamp( "---- [ E ] - window.smt_ui.modal.showFirstChildFromUI():void----------" );
	};
	window.smt_ui.modal.showFirstChildFromUI._clear = function(){ _store = {}; };
})();
